 ...
 *
 * A MinHeap is a binary heap data structure where the parent nodes have a lower value than their children.
 * It provides constant-time complexity for insertion and deletion of the minimum element.
 *
 * This is a class-based implementation of a MinHeap. It provides the following functions:
 *
 * - `insert(value: number): void` - Inserts a value into the heap.
 * - `delete(): number` - Deletes the minimum element from the heap and returns it.
 *
 * The time complexity for the MinHeap operations is O(log n).
 *
 * The space complexity of the MinHeap is determined by the number of elements in the heap.
 *
...
export default class MinHeap {
  ...
  /**
   * @description Initializes a new instance of the MinHeap class.
   * @constructor
   */
  constructor() {
    this.#heap = [];
  ...
  /**
   * @description Deletes the minimum element from the heap and returns it.
   * @returns {number} The minimum element from the heap.
   */
  delete() {
  ...
  #heapifyDown(index) {
    ...
    } else if (rightIndex < this.#heap.length && this.#heap[rightIndex] < this.#heap[index]) {
